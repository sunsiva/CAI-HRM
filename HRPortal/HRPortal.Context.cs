...
public partial class HRPortalEntities : DbContext
{
    ...
    public virtual IQueryable<string> SplitString(string input, string character)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<string>("[HRPortalEntities].[SplitString](@Input, @Character)", inputParameter, characterParameter);
    }


    [DbFunction("HRPortalEntities", "funcSplitValue")]
    public virtual IQueryable<string> funcSplitValue(string splitOn, string list)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<string>("[HRPortalEntities].[funcSplitValue](@SplitOn, @List)", splitOnParameter, listParameter);
    }
    ...
    public virtual int rptGetStagingData(string status, Nullable<bool> round1, Nullable<bool> round2, Nullable<bool> round3)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("rptGetStagingData", statusParameter, round1Parameter, round2Parameter, round3Parameter);
    }
